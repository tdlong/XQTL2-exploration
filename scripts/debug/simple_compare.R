...
new_estimates <- readRDS("process/JUICE/haplotype_results/snp_imputation_adaptive_h8_AJ_1_1_chr2R_DEBUG.RDS") %>% select(POS, imputed) %>% rename(new_estimate = imputed)
