...
# =============================================================================
#
# CRITICAL WARNING: DO NOT EDIT THIS FILE
# This file works with the cluster's dplyr version
# The select(-c("REF", "ALT")) syntax is REQUIRED for older dplyr versions
# DO NOT "fix" or "modernize" this syntax - it will break on the cluster
#
# 
...
process_refalt_data <- function(refalt_file, founders) {
  ...
  df3 <- refalt_data %>%
    ...
    # CRITICAL: DO NOT CHANGE THIS LINE - it works with cluster dplyr version
    # This syntax is required for older dplyr versions on the cluster
    # DO NOT "fix" to select(-REF, -ALT) - that breaks on cluster
    select(-c("REF", "ALT")) %>%
    as_tibble()
